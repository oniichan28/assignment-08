...
const Banner = () => {
  return (
    <div className="flex flex-col justify-center text-center">
      <div>
        <h1 className="font-bold text-[40px] sm:text-[50px] md:text-[60px] leading-tight">
          We Build <br />
        ...
        <p className="text-[#627382] text-base sm:text-lg md:text-[20px] mt-2 px-3">
          <i>
      ...
      <div className="flex flex-wrap justify-center gap-4 py-6">
        <a
          ...
          className="flex items-center gap-2 border px-5 py-3 rounded-xl shadow-md hover:scale-105 hover:shadow-lg transition-transform duration-300 bg-white">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 border px-5 py-3 rounded-xl shadow-md hover:scale-105 hover:shadow-lg transition-transform duration-300">
          <FaApple className="w-6 h-6" />
          <span className="text-lg font-semibold">App Store</span>
        </a>
      </div>
      <div className="flex justify-center items-center">
        <img src={HeroImg} alt="HeroImg" className="max-w-full h-auto" />
      </div>
      <div className="relative left-1/2 -translate-x-1/2 w-screen bg-gradient-to-r from-[#632EE3] to-[#9F62F2] p-6">
        <div className="text-white max-w-6xl mx-auto py-5 mt-2">
          ...
          <div
            className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center mx-5 items-center justify-center
            ">
            <div className="flex flex-col items-center">
              <h3 className="text-2xl font">Total Downloads</h3>
              <div className="flex gap-3 items-center">
                <h3 className="text-4xl font-bold">29.6M</h3>
                <FaDownload size={40} className="mb-2" />
              </div>
            ...
            <div className="flex flex-col items-center sm:col-span-2 lg:col-span-1 justify-self-center">
              <h3 className="text-2xl font">Active Apps</h3>
              <div className="flex gap-3 items-center">
                <h3 className="text-4xl font-bold">132+</h3>
                <SiGoogleplay size={40} className="mb-2" />
              </div>
